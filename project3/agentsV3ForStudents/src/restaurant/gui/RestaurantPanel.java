...
public class RestaurantPanel extends JPanel {
    ...
    static int gridX = 20;
    static int gridY = 15;
    Restaurant restaurant =  new Restaurant("Welcome to My Restaurant", gridX, gridY, true);
	    //**Decide how many tables to have
    private final int nTables = 4;
    ...
    private HostAgent host = new HostAgent("Professor Wilczynski", nTables);
    private CookAgent cook = new CookAgent("Wolfgang Puck", restaurant);
	...
	if(type.equals("Customers")){
	    ...
	    WaiterAgent w = new WaiterAgent(name, gui, aStarTraversal, restaurant, tables);
	    w.setHost(host);
	    w.setCook(cook);
	    host.setWaiter(w);
	    waiters.add(w);
